...
public class LocationFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //
        String spCity = SpUtils.get(getContext(), SP_CITY_NAME_KEY, "");
        if (!TextUtils.isEmpty(spCity)) {
            cityTv.setText(spCity);
            String cityCode = SpUtils.get(getContext(), SP_AD_CODE_KEY, "");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 1001) {
            ...
            if (allGrant) {
                ...
                Toast.makeText(getContext(), "缺少定位权限，请允许！！", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public AMapLocationListener aMapLocationListener = new AMapLocationListener() {
        ...
        public void onLocationChanged(AMapLocation aMapLocation) {
            ...
            if (aMapLocation.getErrorCode() == 0) {
                Log.e("zeffect", ":" + aMapLocation.toStr());
                Log.e("zeffect", "地址：" + aMapLocation.getAddress());
